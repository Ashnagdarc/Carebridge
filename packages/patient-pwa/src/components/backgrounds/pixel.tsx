...
function PixelBackground({
  ...
  const animationRef = React.useRef<ReturnType<typeof requestAnimationFrame> | null>(
    null,
  );
  ...
  React.useEffect(() => {
    ...
    setResolvedTheme(darkMode.matches ? "dark" : "light");
